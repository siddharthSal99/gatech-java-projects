...
public class SquareSet implements Set<Square> {
    ...
    *
    *@param Collection<Square> items that contains the sqaures
    *@return none
    *
    */
    ...
    *
    *@param Square sq, the square to be added
    ...
    *
    *@param Collection of Squares items, the squares to be added
    ...
    *
    *@param Collection of Squares items, the squares to be removed
    ...
    *
    *@param Object o, the sqaure to be checked for availability
    ...
    *
    *@param Object o, the sqaures to be checked for availability
    ...
    *
    *@param Object o, the set to be checked for equality
    ...
    *
    *@param none
    *@return Iterator<Square> to traverse the set
    *
    */
    ...
    *
    *@param collection to be retained
    ...
    *
    *@param T[] a specifies the type of the new array
    *@return object array version of the set
    *
    */
